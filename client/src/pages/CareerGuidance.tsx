...
export const CareerGuidance = () => {
  const { data, isLoading, isError } = useQuery({
    queryKey: ['pageData', 'careerguidance'],
    queryFn: async () => {
      // Mock API for now
      return { title: 'Career Guidance', content: 'Coming soon.' };
    },
    retry: 1
  });
  ...
  return (
    <div className="min-h-screen bg-brand-background text-foreground font-inter">
      <SEO 
        ...
        description="Learn more about Career Guidance at VetNova Training Institute."
      />
      <Navbar />
      ...
      <main className="pt-32 pb-24 min-h-[70vh]">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <nav className="text-sm text-slate-500 mb-8 font-medium">
            <Link to="/" className="hover:text-brand-primary">Home</Link> &gt; <span>Career Guidance</span>
          </nav>
